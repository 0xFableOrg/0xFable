...
contract PlonkVerifier {
    ...
    uint16 constant nPublic   = 68;
    uint16 constant nLagrange = 68;
    
    uint256 constant Qmx  = 11493841461382167680934017778003640450903859212914168092660886634008771196934;
    uint256 constant Qmy  = 4901664735685045233027646083676159470521292733270815274593129365722692615835;
    uint256 constant Qlx  = 12334922221749075158745553835623696454456068085529408307824996784974613024310;
    uint256 constant Qly  = 19281924216697731202137204419401540066016988897280374031910863586549964055462;
    uint256 constant Qrx  = 10322049035286380211882069030613625705210963094619299770892937995544492544866;
    uint256 constant Qry  = 16477663501442517758323567890376542871153428027434044074007382628078157435510;
    uint256 constant Qox  = 12834093283585564944339457272268969395452742965441791771644388822179128433106;
    uint256 constant Qoy  = 14188538067516524368211439120942119661192161634385988404452082915928189580671;
    uint256 constant Qcx  = 3774426791890934986259085749785406479181930387308035698850021405784564955846;
    uint256 constant Qcy  = 7560920916307107549924999228298571319207502159897621894785468788881438473306;
    uint256 constant S1x  = 14492569306168541200106209144918099667902761855132908160542957919241578953591;
    uint256 constant S1y  = 8435608106772562914829177066305696915564108176649185739253617129863678219139;
    uint256 constant S2x  = 4408011738581317809275446500560876296373757949538758452554181834395575478407;
    uint256 constant S2y  = 14234570099838451277854616901701150281419874021933710313043361542854315715700;
    uint256 constant S3x  = 16357881683447634076171852970788016139987387607463443562081280307357911167229;
    uint256 constant S3y  = 3938682199152037470837804814668343736797617005609826413771765018790038428739;
    ...
    uint16 constant lastMem = 2976;

    function verifyProof(uint256[24] calldata _proof, uint256[68] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 2688 ), calldataload(pA))
                mstore(add(mIn, 2720 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 2752 ), calldataload(pB))
                mstore(add(mIn, 2784 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 2816 ), calldataload(pC))
                mstore(add(mIn, 2848 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 2880), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 69 )
