 ...
 */
export function getCards(gdata: FetchedGameData | null = store.get(store.gameData)): readonly bigint[] | null {
 ...
 */
export function getCurrentPlayerAddress(gdata: FetchedGameData | null = store.get(store.gameData)): Address | null {
