    ...
    <>
      ...
      <main className="flex min-h-screen flex-col">
        ...
        <div className="grid-col-1 relative mx-6 mb-6 grid grow grid-rows-[6]">
          ...
          <button className=" btn-warning btn-lg btn absolute right-4 bottom-1/2 z-50 translate-y-1/2 rounded-lg border-[.1rem] border-base-300 font-mono hover:scale-105">
            END TURN
          </button>
