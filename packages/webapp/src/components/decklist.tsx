...
const DeckList: React.FC<DeckListProps> = ({ decks, onDeckSelect }) => {
  return (
    <div>
      {/* New Deck Button */}
      <Link href={"/editor"} className="w-full px-4 py-2 mb-2 border rounded-md text-gray-100 bg-purple-900 hover:bg-gray-500 font-bold text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        New Deck →
      </Link>
